...
//         })
//         console.log('Individual token approval completed')
...
//       console.log('Category bytes:', categoryBytes)
...
//       console.log('NFT Collection Address:', NFT_COLLECTION_ADDRESS)
...
//         console.log('Transaction hash:', listingHash)
//       }
//     } catch (error) {
